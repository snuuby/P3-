...
function EmployeeOverviewTable(props)
{
    ...
    const searchText = useSelector(({ employeeReducer }) => employeeReducer.employees.searchText);
    ...
    useEffect(() => {
        setData(searchText.length === null ? employees : FuseUtils.filterArrayByString(employees, searchText))
