                    ...
                    <CardContent className="p-88 print:p-0">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className={clsx(classes.seller, "flex items-center p-16")}>
                                ...
                                <img className="w-80" src="assets/images/logos/HasserisFlytteforetningRigtigManLogo.svg" alt="logo"/>
                        ...
                        <div className="mt-96">
                            ...
                            <div className="flex">
                                ...
                                <div className="flex-shrink-0 mr-24">
                                    <img className="w-32" src="assets/images/logos/HasserisFlytteforetningRigtigManLogo.svg" alt="logo"/>
                                </div>
