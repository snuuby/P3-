...
import TaskOverviewHeader from './TaskOverviewHeader.js';
...
function TaskOverview(props) {
    ...
    function redirectToAddTask(event) {
        ...
        <FusePageCarded
            ...
            content={
                <div>
                    ...
                    <TaskOverviewTable history={props.history}/>
                    ...
                    <FuseAnimate animation="transition.expandIn" delay={500}>
                        ...
                        >
                            <Icon onClick={redirectToAddTask}>add</Icon>
                        </Fab>
                    </FuseAnimate>
...
export default withReducer('taskReducer', reducer)(TaskOverview);
