...
function CustomerOverviewHeader(props)
{
    ...
    const tasks = useSelector(({ taskReducer }) => taskReducer.tasks.tasks);
        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">Opgave oversigt</Typography>
                </FuseAnimate>
            </div>
                    ...
                    <FuseAnimate animation="transition.slideDownIn" delay={300}>
                        <Paper className="flex items-center w-full max-w-512 px-8 py-4 rounded-8" elevation={1}>
                            ...
                            <Input
                                ...
                                onChange={ev => dispatch(Actions.setTaskOverviewSearchText(ev))}
                            />
                        </Paper>
                    </FuseAnimate>
                </ThemeProvider>
