...
function TaskOverviewTableHead(props)
{
                ...
                {rows.map(row => {
                    return (
                        <TableCell
                            ...
                            sortDirection={props.task.id === row.id ? props.task.direction : false}
                        >
                            {row.sort && (
                                <Tooltip
                                    title="Sort"
                                ...
                                >
                                    <TableSortLabel
                                        active={props.task.id === row.id}
                                        direction={props.task.direction}
