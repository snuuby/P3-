...
function InspectionsOverviewHeader(props)
{
        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">Besigtigelsesrapporter</Typography>
                </FuseAnimate>
            </div>
                    ...
                    <FuseAnimate animation="transition.slideDownIn" delay={300}>
                        <Paper className="flex items-center w-full max-w-512 px-8 py-4 rounded-8" elevation={1}>
                            ...
                            <Input
                                ...
                                onChange={ev => dispatch(Actions.setInspectionOverviewSearchText(ev))}
                            />
                        </Paper>
                    </FuseAnimate>
                </ThemeProvider>
...
export default InspectionsOverviewHeader;
