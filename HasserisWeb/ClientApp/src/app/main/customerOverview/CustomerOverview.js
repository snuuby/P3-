...
function CustomerOverview(props) {
    ...
    const customersRedux = useSelector(({customerReducer}) => customerReducer.customers.entities);
...
export default withReducer('customerReducer', reducer)(CustomerOverview);
