...
=======
            ...
            using (var db = new HasserisDbContext())
            {
                ...
                Employee tempEmployee_two = new Employee("Kristian", "Eriksen", "Employee", 150, new ContactInfo("Kesseeriksen@gmail.com", "50734649"), new Address("Herningvej", "9220", "Aalborg", "Til højre"));
